...
// Encodes the message prepended by the varint encoded tag and varint of the
// serialized length.
UPB_API upb_EncodeStatus upb_EncodeTagLengthPrefixed(
    const upb_Message* msg, const upb_MiniTable* l, int options,
    upb_Arena* arena, char** buf, size_t* size, uint32_t tag);
